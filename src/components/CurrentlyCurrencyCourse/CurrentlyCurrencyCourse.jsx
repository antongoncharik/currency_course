...
const CurrentlyCurrencyCourse = (props) => {
    ...
    const course = props.currenciesCourses.find(item =>
        item.currencyId === props.selectedCurrencyId).course;

    const currencyAbbreviation = props.currencies.find(item =>
        item.currencyId === props.selectedCurrencyId).currencyAbbreviation;
